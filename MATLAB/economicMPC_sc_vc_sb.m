...
function [xt, yt, ut, t, total_cost] = economicMPC_sc_vc_sb(ssM, param_constraints, param_objective, param_simulation)
...
parameters_in = [x0; d(:); cp(:); sb(:)];
solutions_out = u;
controller = optimizer(constraints, objective, ops, parameters_in, solutions_out);

%simulate the system
option = 3; %simulation with variable cost and night-setbacks
